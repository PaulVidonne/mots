Présentation des fichiers de ce dépôt, à jour le 05/05/2023.
...
Le script bash **iban** version 2.00 b-20230505 calcule le RIB et l'IBAN d'un compte bancaire français à partir des numéros de la banque, du guichet et du compte. Il permet de vérifier la validité d'un IBAN, quel que soit le pays d'émission. Le résultat peut être envoyé dans un fichier.
